...
hugo
hugo -d ../barthac.github.io # This builds the public site into your public repo. !!!!! Make sure to replace with your currect public repo here

# Deploy your public site
cd ../barthac.github.io # Goes to your public site repo
...
git push origin # Pushes the code to GitHub
